                        ...
                        <div id="home" align="center">
                            <ul>
                                <li align="center" id="search">
                                    <big><big><h2 align="center">Acervo</h2></big></big>
                                    <table align="center">
                <form lign="center" action="" method="post">
                    <tr>
                        <input align="center" type="text" maxlength="500" id="s" name="pnome"  /></br></br>
                                            <input align="center" type="submit" id="x" value="Pesquisar" />
                    </tr>
                </form>
            </table>
                                </li>
