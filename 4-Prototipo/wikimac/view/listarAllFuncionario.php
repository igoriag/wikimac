...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        function alerta()
        {
            decisao = confirm("Deseja realmente excluir Funcionario?");
if (decisao){
...
<div id="session">
    ...
    <br></br><br></br>
        ...
        if(!empty($_POST["pnome"])){
             $usuarios = $usuarioDAO->getFuncionarioByNome($_POST["pnome"]);
        }else{
             $usuarios = $usuarioDAO->listarAllFuncionario();
        }
        ...
        foreach ($usuarios as $usuario) {
            ...
            echo "  <td><a onclick='alerta()' href='../controller/excluirFuncionarioController.php?id={$usuario["idusuario"]} '>Excluir</a></td>";
            echo "  <td><a href='../view/formAlterarFuncionario.php?id={$usuario["idusuario"]}'>Alterar</a></td>";
            echo "</tr>";
            echo "<tr style='background-color:black'>";
                        echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";
                        echo "</tr>";
