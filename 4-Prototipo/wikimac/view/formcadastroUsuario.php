...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head><script type="text/javascript">
        function alerta()
        {
            alert("funcionário cadastrao com sucesso!")
        }
    </script>
                ...
                <ul>
                    ...
                    <li id="search" align="center">
                        ...
                        <table border='0' align='center'>
                            ...
                            <form id="form" action="../controller/cadastrarUsuarioController.php" method="post">
                                <TABLE BORDER='0' align='center'> </br></br>
                                    ...
                                    <fieldset>	
                                        ...
                                        <td align='right'> Nome </td><td><input type="text" id="nome" class="maiusculo" required='required' name="nome" value="" /></td>
                                        </tr>
                                        <tr>  
...
function cpf_mask(v){
	...
	return v
                                        ...
                                        <tr>  
                                            <td align='right'> Endereço</td><td> <input class="maiusculo" type="text" id="s2" required='required' name="endereco" value="" /></td>
                                            <td align='right'>CEP  </td><td><input type="text" id="cep" required='required' name="cep" value="" /> </td>
                                        </tr> 
                                        
                                        
                                        <tr> 
                                            <td align='right'> Data nascimento</td><td> <input type="date" id="s2" required='required' name="data_nascimento" value="Recomenda-se usar o nome" /></td>
...
$(".login2").blur(function(){ if($(this).val() == ""){ $(this).val(""); } }); });
 ...
 <input type="text" class="login2" name="login" id="s2" value="Recomenda-se utilizar o nome." /> 
                                        ...
                                        <tr> 
                                            ...
                                            <td align='right'> Senha</td><td><input type="password" id="s2" required='required' name="senha" value="" /></td>
                                            <td align='right'> Confirmar Senha</td><td><input type="password" id="s2" required='required' name="confirmar_senha" value="" /></td>
                                        </tr>
                                        <tr>   
                                            ...
                                            <label>Selecione o País:</label>
                                             ...
                                             <option>Carregar Paises</option>
                                                    ...
                                                    <input type="button" size="100px" value="Carregar Pais" id="btnPais" class="botao"/>
                                                </td>
                                             </div>
...
<center>
 ...
 <script type="text/javascript">
        ...
        <div id="logo2">
            <a href="#"><img src="../images/logo.png" alt="" width="90" height="90" /></a>
        </div>
    </body>
</html>
