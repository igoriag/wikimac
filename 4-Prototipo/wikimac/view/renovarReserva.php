...
<script type="text/javascript">
        function alerta()
        {
            alert("Renovação efetuada com sucsso! \nSua reserva é válida por 2 semanas!")
        }
    </script>
<div id="header">
		...
		<ul>
			...
			<li id="search" align="center">
				<h2>Renovar Reserva</h2>
                                <form method="post" action="wikimac.php">
					<fieldset>
                                            <p align="center">
                                                Sua reserva será válida por 2 semanas, deseja continuar?
                                            </p>
                                            
                                            <label>Código do livro</label><input type="text"  id="s2" name="senha" value="" /></br></br>
					<input class="button" onclick="alerta()" type="submit" name="acao" value="Continuar" align="center" /></br>
					</fieldset>
				</form>
			</li>
