            ...
            <div id="sidebar">
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="formcadastro_funcionario.php">Cadastrar Funcionário</a></li>
                            <li><a href="formcadastro_usuario.php">Cadastrar Usuário</a></li>
                            <li><a href="formcadastro_livro.php">Cadastrar livros</a></li>
                            <li><a href="#">Reservar livros</a></li>
                            <li><a href="#">Renovar Reserva </a></li>
