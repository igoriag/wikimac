...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        function alerta()
        {
            decisao = confirm("Deseja realmente devolver este livro?");
        ...
        <br>
            ...
            <div id="heade2">
                    ...
                    if(!empty($_POST["pnome"])){
                            $emprestimos = $emprestimoDAO->getEmprestimoByNome($_POST["pnome"]);
                    }else{
                    ...
                    echo "  <td><b>Serviços</b></td>";
                    echo "</tr>";
                    echo "<tr style='background-color:black'>";
                        echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";
                        echo "</tr>";
                    
                    foreach ($emprestimos as $emprestimo) {
//                        print_r($emprestimo);
//                        exit();
                        if($emprestimo["status"] == 'Ocupado'){
                        ...
                        echo "  <td><a  onclick='alerta()' href='../controller/devolverLivroController.php?id={$emprestimo["acervo_idAcervo"]}'>Devolver</a></td>";
                        
                        echo "</tr>";
                        echo "<tr style='background-color:black'>";
                        echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";echo "<td>";echo "</td>";
                        echo "</tr>";
                    }}
